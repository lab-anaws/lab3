...
PROCESS_THREAD(unicast_sender_process, ev, data)
{
  ...
  while(1) {
    ...
    uip_ip6addr(&addr, 0xfe80, 0, 0, 0, 0xc30c, 0, 0, 0x0005);  
    ...
    printf("\n");
    sprintf(buf, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA Message %d", message_number);
